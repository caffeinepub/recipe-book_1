...
export const SAMPLE_RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    category: "Accompaniments",
    description:
      "An Indian-adapted kimchi — shredded cabbage fermented with ginger, garlic, red chilli, and mustard seeds for a tangy, crunchy, probiotic-rich condiment. Excellent alongside rice, dal, or as a bold side to any meal.",
    prepTime: "30 min (+ 1–2 days fermentation)",
    cookTime: "0 min",
    ingredients: [
      "1 medium cabbage (about 800g), shredded into thin strips",
      "2 tbsp salt",
    ...
    steps: [
      "Toss shredded cabbage and carrot with salt in a large bowl. Massage the salt into the cabbage for 5 minutes. Leave for 1–2 hours until the cabbage releases its water.",
      "Rinse the salted cabbage under cold water 2–3 times to remove excess salt. Squeeze well to remove as much water as possible.",
      "In a small bowl, mix ginger, garlic, red chilli powder, mustard seeds, and sugar into a paste.",
      "Combine the squeezed cabbage, carrot, and spring onions in a large bowl. Add the chilli paste and mix thoroughly, wearing gloves to avoid staining.",
      "Pack the kimchi tightly into a clean glass jar, pressing down so there are no air pockets. Leave an inch of space at the top.",
      "Leave the jar at room temperature for 1–2 days to ferment, pressing down the cabbage once a day. It's ready when it smells tangy and tastes pleasantly sour.",
      "Refrigerate once the desired sourness is reached. Kimchi keeps in the fridge for 2–3 weeks and improves with age.",
    ],
    alternates: [
      {
        original: "Red chilli powder",
        alternate:
          "Korean gochugaru (if available) for authenticity, or use less Indian chilli powder",
        reason:
          "Indian red chilli powder is hotter than Korean gochugaru; use ½ the quantity if using Indian chilli powder to control heat.",
      },
      {
        original: "Mustard seeds",
        alternate: "A pinch of mustard powder or skip entirely",
        reason:
          "Lightly crushed mustard seeds add an Indian twist; they can be omitted for a more classic kimchi flavour.",
      },
      {
        original: "Cabbage",
        alternate: "Napa cabbage (Chinese cabbage) if available",
        reason:
